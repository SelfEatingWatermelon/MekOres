...
public class Log {
	public static final Marker MOD_MARKER = MarkerManager.getMarker(MekOres.MODID);
	...
	public static void info(Exception e, String format, Object... data) {
		logger.error(String.format(format, data), e);
	}
	
	public static void debug(Exception e, String format, Object... data) {
		logger.error(String.format(format, data), e);
	}
	
	public static void warn(Exception e, String format, Object... data) {
		logger.error(String.format(format, data), e);
	}
	
	public static void error(Exception e, String format, Object... data) {
		logger.error(String.format(format, data), e);
	}
